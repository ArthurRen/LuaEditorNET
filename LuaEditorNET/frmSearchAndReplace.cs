...
{
    partial class frmSearchAndReplace : Form
    {
        private static frmSearchAndReplace _frm = null;
        private static object _lck = new object();
        public static frmSearchAndReplace Instance
        {
            get
            {
                if (_frm == null)
                {
                    lock (_lck)
                    {
                        if (_frm == null)
                        {
                            _frm = new frmSearchAndReplace();
                            _frm.TopMost = true;
                            _frm.FormClosing += (obje, args) =>
                            {
                                args.Cancel = true;
                                _frm.Visible = false;
                            };
                            _frm.FormClosed += (obj, args) =>
                            {
                                _frm = null;
                            };
                        }
